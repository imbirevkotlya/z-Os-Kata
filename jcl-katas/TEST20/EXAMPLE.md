# Another copy options in JCL

## Simple kata to copy dataset internals with modification options
...
4. Utility explanation: [MainframeTechHelp](https://www.mainframestechhelp.com/utilities/icetool/)
